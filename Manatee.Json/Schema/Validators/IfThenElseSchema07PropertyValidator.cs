    ...
    internal class IfThenElseSchema07PropertyValidator : IJsonSchemaPropertyValidator
    {
        ...
        public SchemaValidationResults Validate(IJsonSchema schema, JsonValue json, JsonValue root)
        {
            ...
            if (ifResults.Valid)
            {
                ...
                return new SchemaValidationResults(schema, string.Empty, message, validationKeyword: "then", innerErrors: thenResults.Errors);
            }
            ...
            return new SchemaValidationResults(schema, string.Empty, message, validationKeyword: "else", innerErrors: elseResults.Errors);
        }
